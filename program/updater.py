...
async def update_repo(_, message: Message):
    ...
    if update_avail:
        ...
        return
    await msg.edit("bot is **up-to-date** with [main](https://github.com/islam-200555/verson/tree/main)", disable_web_page_preview=True)


@Client.on_message(command(["اعادة التشغيل", f"restart@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
